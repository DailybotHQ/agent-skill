...
- Merge pull request #51 from DailybotHQ/feat/tasks-open-org-member-permissions
- docs(tasks): open-org member structure access, no admin prerequisite
...
- Merge pull request #47 from DailybotHQ/fix/duplicate-deep-walk-paragraph
- fix(tasks): drop the duplicated "deep walk is approximate" paragraph
...
- Merge pull request #44 from DailybotHQ/feature__personalized_universal_labels
- feat(labels): teach agents to assign org Labels on forms, check-ins, and workflows
- feat(skill): add dailybot-labels and dailybot-featured sub-skills
...
- Merge pull request #40 from DailybotHQ/docs/kudos-wall-of-fame-payload
- docs(kudos): reference the released dailybot-cli v3.7.2 in the wall-of-fame version note
- docs(kudos): document the real wall-of-fame JSON payload shape
...
- Merge pull request #39 from DailybotHQ/docs/cli-3.7.0-baseline
- docs(pack): raise the skill-pack CLI baseline to 3.7.0 everywhere
...
- Merge pull request #38 from DailybotHQ/docs/cli-3.7.0-release-alignment
- docs(env-json): align skill with released CLI 3.7.0 behavior
...
- Merge pull request #35 from DailybotHQ/feat/cli-3.5.1-auth-unification
- docs(auth): document unified Bearer-first auth priority and auto-retry (CLI 3.5.1)
